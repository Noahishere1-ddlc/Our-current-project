label Test:
    ...
    nic "My, that is quite a predicament isn't it?"
    nic "There is {i}one{/i} way we can save them."
    nic "The boy's eyes go wide."
    ...
    nic "I implore you boy, to reform your soul."
