...
define audio.soliloquy =  "mod_assets/bgm/Soliloquy.flac" # Soliloquy - Chaos;Head OST
...
# mc definitions file so people don't have to die inside compiling it themselves
...
define nic = Character('???', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define ma = Character('Mr. Adams', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
